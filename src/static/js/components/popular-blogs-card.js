class PopularBlogsCard extends HTMLElement {
    ...
    render() {
        const popularBlogs = [
            { name: '技术前沿', followers: '1.2k', avatar: '技' },
            { name: '生活美学', followers: '856', avatar: '生' },
            { name: '编程之道', followers: '743', avatar: '编' },
            { name: '摄影艺术', followers: '621', avatar: '摄' },
            { name: '读书会', followers: '589', avatar: '读' }
        ];
                    ...
                    <div class="blog-list">
                        ${popularBlogs.map((blog, index) => `
                            <a href="/blog/${blog.name}" class="blog-item">
                                ...
                                <div class="blog-rank">#${index + 1}</div>
                            </a>
                        `).join('')}
                    </div>
                </div>
